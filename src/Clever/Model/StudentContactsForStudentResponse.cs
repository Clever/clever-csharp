...
namespace Clever.Model
{
    ...
    public partial class StudentContactsForStudentResponse :  IEquatable<StudentContactsForStudentResponse>, IValidatableObject
    {
        ...
        public List<StudentContact> Data { get; set; }
        ...
        {
            return this.Equals(input as StudentContactsForStudentResponse);
        }

        /// <summary>
        /// Returns true if StudentContactsForStudentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StudentContactsForStudentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StudentContactsForStudentResponse input)
        {
            if (input == null)
                return false;
