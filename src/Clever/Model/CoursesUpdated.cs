...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CoursesUpdated : ModelEvent,  IEquatable<CoursesUpdated>, IValidatableObject
    {
        /// <summary>
        ...
        public CoursesUpdated(CourseObject Data = default(CourseObject), string Created = default(string), string Id = default(string), string Type = default(string)) : base()
        {
            this.Data = Data;
        }
